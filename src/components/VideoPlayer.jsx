      ...
      <div className="relative bg-black rounded-xl overflow-hidden aspect-video">
        {videoError ? (
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 p-6">
            ...
            <p className="text-slate-600 text-xs text-center font-mono">Make sure the server is running:</p>
            <code className="bg-slate-800 text-green-400 text-xs px-3 py-2 rounded-lg">
              npm run start
            </code>
            <p className="text-slate-600 text-xs text-center font-mono break-all max-w-full px-2">
              {workout.filename}
            </p>
          </div>
        ) : (
